...
export const ShippingPage = ({}: IShippingPageProps) => {
	...
	return (
		<section className={cl(styles.shipping)}>
			<div className="container">
				<h2
					className={cl(styles.shipping__title, {
				...
				<div
					className={cl(styles.shipping__tabs, {
						[styles.dark]: mode === 'dark',
					})}
				>
					<ul
						className={cl(styles.shipping__tabs_list, {
							[styles.dark]: mode === 'dark',
						})}
					>
						{tabs.map((item, i) => (
							<li
								key={item.id}
								className={cl(styles.shipping__item, {
					...
					<div
						className={cl(styles.shipping__tabs_content, {
							[styles.dark]: mode === 'dark',
						})}
					>
						{tabsText.map((item, i) => {

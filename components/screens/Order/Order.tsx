...
export const Order = ({}: IOrderProps) => {
	...
	const makePay = async () => {
		try {
			const data = await makePaymentFx({
				url: '/payment',
				amount: totalPrice,
				description: `Заказ поступил ${
					userCity.city?.length && userCity.street?.length
	...
	return (
		<section className={cl(styles.order)}>
			<div className="container">
				<h2
					className={cl(styles.order__title, {
				...
				<div
					className={cl(styles.order__inner, {
						[styles.dark]: mode === 'dark',
					})}
				>
					<div
						className={cl(styles.order__cart, {
							[styles.dark]: mode === 'dark',
						})}
					>
						<OrderAccordion
					...
					<div className={cl(styles.order__pay)}>
						<h3
							className={cl(styles.order__pay_title, {
								[styles.dark]: mode === 'dark',
							})}
						>
							Итого
						...
						<div
							className={cl(styles.order__pay_inner, {
								[styles.dark]: mode === 'dark',
							})}
						>
							<div
								className={cl(styles.order__pay_item, {
									[styles.dark]: mode === 'dark',
								})}
							>
							...
							<button
								...
								className={cl(styles.order__pay_btn, {
									[styles.dark]: mode === 'dark',
								})}
							>
							...
							>
								...
								/>
								<span
									className={cl(styles.order__pay__rights_text, {
										[styles.dark]: mode === 'dark',
									})}
								>

...
const OrderAccordion = ({ setOrderIsReady, showDoneIcon }: IOrderAccordion) => {
  ...
  const closeAccordion = () => {
	...
	return <>
      ...
      >
       <h3 className={cl(styles.order__cart_title,{
					[styles.dark]:mode==='dark'
				})}>
          {showDoneIcon ? (            
              <DoneSvg />
        ...
        >
          ...
          >
           <div className={cl(styles.order__cart_content,{
            [styles.dark]:mode==='dark'
           })}>
             <ul className={styles.order__cart_list}>
                {!!shoppingCart.length? shoppingCart.map((item)=>
                 ...
                 (<OrderItem item={item} key={item.id} mode={mode}/>)
                  ...
                  <li className={cl(styles.order__cart_empty,{
                    [styles.dark]:mode==='dark'
                  })}>                  
                    Корзина пуста                
                </li>
           ...
           <div className={cl(styles.order__cart_footer,{
            [styles.dark]:mode==='dark'
           })}>
                <div className={styles.order__cart_footer_total}>
                  ...
                  <span  className={cl(styles.order__cart_footer_total_price,{
                    [styles.dark]:mode==='dark'
                  })}>

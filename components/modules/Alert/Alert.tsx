...
export const Alert = ({ count, closeAlert, mode,totalPrice }: IAlertProps) => (
	...
	>
		<div className={cl(styles.alert__info,{
      [styles.dark_mode]:mode==='dark'
    })}>
			<span>В корзине {count}{' '}{sklonenie(count,['товар','товара','товаров'])}</span>
	  ...
	  <button onClick={closeAlert} className={cl(styles.alert__btn,{
    	[styles.dark_mode]: mode === 'dark',  
    })}>
    <CloseSvg />
    </button>
